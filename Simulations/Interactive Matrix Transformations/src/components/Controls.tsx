...
export function Controls({ 
  ...
  const presets = matrixSize === 2 ? [
    ...
    { name: "Scale 2x", key: "scale2x" },
    { name: "Scale 0.5x", key: "scale05x" },
    { name: "Rotate Z 45°", key: "rotate45" },
    { name: "Rotate Z 90°", key: "rotate90" },
    { name: "Rotate X 90°", key: "rotateX90" },
    { name: "Rotate Y 90°", key: "rotateY90" },
    { name: "Shear XY", key: "shearX" },
    { name: "Reflect Z", key: "reflectZ" },
  ];
